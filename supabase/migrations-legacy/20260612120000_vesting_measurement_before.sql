-- ============================================================================
-- Migration: valor "antes" nas medições semanais de vesting (antes / depois)
-- ============================================================================
-- Cada medição semanal passa a registrar o par:
--   value_before — valor do indicador no INÍCIO da semana (x)
--   value        — valor ao FIM da semana (y), já existente
-- A UI exibe "x / y" e pré-preenche value_before com o "depois" da semana
-- anterior (carry-forward), mantendo-o editável.
--
-- Também atualiza a RPC get_public_ongoing para expor value_before no link
-- público (mesma superfície de dados, apenas o novo campo numérico).
--
...
-- RPC: inclui value_before no payload público --------------------------------
...
-- ROLLBACK (manual)
-- ============================================================================
-- ALTER TABLE public.vesting_measurements DROP COLUMN IF EXISTS value_before;
-- (e recriar get_public_ongoing da migration 20260611150000)
-- ============================================================================
