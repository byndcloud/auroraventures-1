...
-- Create role enum
CREATE TYPE public.app_role AS ENUM ('founder', 'colaborador', 'admin');
...
CREATE TABLE public.submissions (
  ...
  type TEXT NOT NULL CHECK (type IN ('mercado', 'interna', 'editais')),
...
BEGIN
  ...
  VALUES (
    ...
    COALESCE((NEW.raw_user_meta_data->>'role')::app_role, 'founder')
  );
