...
import { Field, TextAreaField, SectionTitle } from "@/components/submission/FormField";
import { Plus, Trash2, UserCircle } from "lucide-react";
import type { FounderDataInterna } from "@/pages/SubmissionInterna";

interface Props {
  founders: FounderDataInterna[];
