...
const StepExpectations = ({ form, update, isSimplified = false }: Props) => {
  ...
  return (
    <>
      ...
      <TextAreaField label="Em quais áreas você espera receber mais ajuda? (Ex: Vendas, Desenvolvimento de Software, Jurídico, Contatos B2G)" value={form.expectations} onChange={(v) => update("expectations", v)} minH="120px" required={opt} />
    </>
  );
};
